...
public static class Metric
{
    ...
    public static int NumOfCommands(this Program program)
    {
    ...
    public static int MaxNestingDepth(this Program program)
    {
    ...
    public static int NumOfRepeatCommands(this Program program)
    {
        return RecursiveRepeat(program.Commands, count: 0);
    ...
    public static (Point, Size) MaxGridSize(this Program program, Player p)
    {
